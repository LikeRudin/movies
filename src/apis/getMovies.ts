export const getMovies = async () => {
    ...
    const typeData = new ObjectTypeChecker(json.data.results[0]);
    typeData.getTypeAsString();
    typeData.getArrayPropertiesAsString();
    typeData.getObjectPropertiesAsString();
    console.log()
    }catch(e) {
      alert(e);
      console.log(e)
